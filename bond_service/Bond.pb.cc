...
void protobuf_AssignDesc_Bond_2eproto() {
  protobuf_AddDesc_Bond_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "Bond.proto");
  GOOGLE_CHECK(file != NULL);
  Bond_descriptor_ = file->message_type(0);
  static const int Bond_offsets_[5] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Bond, name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Bond, coupon_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Bond, payments_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Bond, interestrate_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Bond, parvalue_),
  };
  Bond_reflection_ =
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_Bond_2eproto);
}
...
void protobuf_AddDesc_Bond_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "upon\030\002 \002(\002\022\020\n\010payments\030\003 \002(\005\022\024\n\014interest"
    "Rate\030\004 \002(\002\022\020\n\010parValue\030\005 \002(\002", 108);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "Bond.proto", &protobuf_RegisterTypes);
  Bond::default_instance_ = new Bond();
  Bond::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_Bond_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_Bond_2eproto {
  StaticDescriptorInitializer_Bond_2eproto() {
    protobuf_AddDesc_Bond_2eproto();
  }
} static_descriptor_initializer_Bond_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int Bond::kNameFieldNumber;
const int Bond::kCouponFieldNumber;
const int Bond::kPaymentsFieldNumber;
const int Bond::kInterestRateFieldNumber;
const int Bond::kParValueFieldNumber;
#endif  // !_MSC_VER

Bond::Bond()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Bond)
}
...
Bond::Bond(const Bond& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Bond)
}
...
Bond::~Bond() {
  // @@protoc_insertion_point(destructor:Bond)
  SharedDtor();
}
...
const Bond& Bond::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Bond_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Bond)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Bond)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Bond)
  return false;
#undef DO_
}
...
void Bond::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Bond)
  // optional string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:Bond)
}

::google::protobuf::uint8* Bond::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Bond)
  // optional string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Bond)
  return target;
}
